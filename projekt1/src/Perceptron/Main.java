...
public class Main {
    public static void main(String[] args) {
        File file = new File("C:\\Users\\glusz\\projektNAI\\projekt1\\src\\Perceptron\\train.txt");


        File testFile = new File("C:\\Users\\glusz\\projektNAI\\projekt1\\src\\Perceptron\\test.txt");
